...
for filename in ./videos/raw/*; do
    ...
    for hidden_msg_filename in ./messages/$videoid/*; do
        ...
        python3 ./scripts/python/retrieve_decoded_message.py ./results/decode_outputs/$case_id.txt message > ./results/hidden_messages/$case_id.hex
        python3 ./scripts/python/retrieve_decoded_message.py ./results/decode_outputs/$case_id.txt stats > ./results/hidden_information_stats/$case_id.txt
    done
done